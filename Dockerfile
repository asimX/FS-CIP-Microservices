...
ENV COS_ENDPOINT=https://s3.us-east.objectstorage.softlayer.net
ENV COS_API_KEY=DuNGVFOk8S9uTLBRHriXNomf0b-JcUxLZI9ADGXlUpVH
ENV COS_IBM_AUTH_ENDPOINT=https://iam.ng.bluemix.net/oidc/token
ENV COS_SERVICE_INSTANCE_ID=crn:v1:bluemix:public:cloud-object-storage:global:a/170d3f7e5a856289f8562a444df4c067:fda060df-5a2d-4aa8-824a-ce23d8b821a1:bucket:acmemartupload
ENV COS_ACME_MART_BUCKET_NAME=acmemartupload
